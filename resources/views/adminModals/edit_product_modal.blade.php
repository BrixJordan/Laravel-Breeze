<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden" id="editProductModal{{ $product->id }}">
    <div class="bg-white rounded-lg shadow-lg w-1/3">
        <div class="flex justify-between items-center border-b p-4">
            <h3 class="text-lg font-semibold">Edit Product</h3>
            <button class="text-gray-400 hover:text-gray-600 closeEditModalButton" data-product-id="{{ $product->id }}">&times;</button>
        </div>
        <div class="p-4">
...
<script>
    ...
    const openModalButtons = document.querySelectorAll('.openEditModalButton');
    ...
    const closeModalButtons = document.querySelectorAll('.closeEditModalButton');
